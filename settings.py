...
TEMPLATES = [
    ...
    #     "DIRS": [os.path.join(PROJECT_DIR, f'{f}/jinja2templates/') for f in os.listdir(PROJECT_DIR) if os.path.isdir(f) and f in INSTALLED_APPS],
    #     "OPTIONS": {"environment": "adminlte3.jinja2.environment",}
    # },
    {
